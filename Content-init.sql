CREATE DATABASE IF NOT EXISTS contents_service;

USE contents_service;
...
VALUES
    ...
    (@uuid5, 'Machine Learning Fundamentals', 'An introductory course on machine learning.', 'course-501', 'https://example.com/machine-learning-fundamentals', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);